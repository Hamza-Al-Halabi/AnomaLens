...
class GRUModel(nn.Module):
    """
    GRU-based binary classifier for time series anomaly detection.
...
if __name__ == "__main__":
    ...
    print("=" * 55)
    print("GRU — BATADAL quick test (1 seed)")
    ...
    model = GRUModel(config, n_features)
